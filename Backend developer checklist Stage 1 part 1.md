...
**ИНКАПСУЛЯЦИЯ** обеспечивает модульность (все в одном месте)  и облегчает переиспользование 
...
### **Множественное наследование, проблема ромбовидного наследования. Наследование через интерфейсы, делегирование.**
*
http://jem-space.ru/skrytyie-sokrovishcha-obiektnoi-kompozitsii/
...
ДЕЛЕГИРОВАНИЕ - это подмножество Агрегация - включение объекта как части нового объекта.
...
Примеры
Встроенные типы JavaScript используют **делегирование** для отсылки к встроенным методам, 
вызывающим цепочку прототипов. Например, [] .map () делегирует Array.prototype.map (), 
obj.hasOwnProperty () делегирует Object.prototype.hasOwnProperty () и так далее.
