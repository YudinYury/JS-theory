...
обеспечивают управляемый доступ к данным объекта. Геттеры и сеттеры иногда называют методами 
доступа и методами-модификаторами соответственно.
Геттеры и сеттеры в действительности являются свойствами атрибутов — например, свойство get 
атрибута с именем Name.
