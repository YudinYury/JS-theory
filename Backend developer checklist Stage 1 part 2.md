...
Вопросы в этом разделе:
  * Шаблоны (понимание, обоснование применения): [Издатель-подписчик (Publish–subscribe)](#publish–subscribe),  [Одиночка](#singleton), [Фабричный метод](#ФАБРИЧНЫЙ-МЕТОД), Абстрактная фабрика.
  * [MVC - Отношения между моделью, вьюхой и контроллером](#mvc)
  * [СОЛИД, первые четыре принципа (поверхностное представление)](#solid)
...
****************************************************************************
### **Шаблоны (понимание, обоснование применения): Издатель-подписчик (Publish–subscribe), Одиночка, **
### **Фабричный метод, Абстрактная фабрика.**

#### Publish–subscribe
https://refactoring.guru/ru/design-patterns/observer
https://pro-prof.com/archives/2400
*
...
class HTTPCreator extends FactoryCreator { 
  SocialConnect() { return new VkHTTP() } 
}
class GraphQLCreator extends FactoryCreator { 
  SocialConnect() { return new VkGraphQL() } 
}
class GraphQLFacebookCreator extends FactoryCreator { 
...
****************************************************************************
### MVC
### Отношения между моделью, вьюхой и контроллером.
*
...
****************************************************************************
### SOLID
### первые четыре принципа (поверхностное представление).
*
